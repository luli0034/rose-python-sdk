...
class PipelineBuilder:
    ...
    def add_dataset(self, dataset_key: str, dataset_id: str) -> 'PipelineBuilder':
        ...
        if dataset_key not in self.scenario_config["dataset_keys"]:
            raise ValueError(f"Dataset key '{dataset_key}' not supported for scenario '{self.scenario}'. "
...
def create_telasa_pipeline(
    account_id: str,
    pipeline_name: str,
    interaction_log_dataset_id: str,
    item_metadata_dataset_id: str
) -> Dict[str, Any]:
    """
    ...
    """
    return (PipelineBuilder(account_id, pipeline_name, scenario="telasa")
...
def create_realtime_leaderboard_pipeline(
    ...
    Returns:
        Pipeline configuration dictionary
    """
    return (PipelineBuilder(account_id, pipeline_name, scenario="realtime_leaderboard")
