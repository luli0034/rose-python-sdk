...
class RoleService:
    ...
    def create(self, role_name: str, permission: Optional[str] = None, 
        with_token: Optional[bool] = False, 
        token_expiration: Optional[int] = None) -> Role:
        """
        Create a new role.
    ...
    def issue_token(self, role_id: str, expired_at: Optional[int] = None, expiration: Optional[int] = None, tenant_id: Optional[str] = None) -> RoleWithToken:
        """
