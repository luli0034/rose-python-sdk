...
from ..models.pipeline import Pipeline, CreatePipelineRequest, UpdatePipelineRequest, CreatePipelineResponse, PipelineStatus
...
class PipelineService:
    ...
    def list_queries(self, pipeline_id: str) -> List[Query]:
        ...
        if pipeline.status != PipelineStatus.CREATE_SUCCESSFUL:
            raise ValueError(f"Cannot list queries for pipeline {pipeline_id}. "
